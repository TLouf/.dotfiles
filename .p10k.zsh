# Generated by Powerlevel10k configuration wizard on 2024-02-24 at 12:17 UTC.
...
() {
  ...
  function my_git_formatter() {
    ...
    #local      clean=231   # white foreground
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=75
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=231
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=75
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=231
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=75
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=231
